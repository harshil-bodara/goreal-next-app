...
export default function Buy100InstagramFollowers() {
  return (
    <div>
                                    ...
                                    <div className="row row--0 align-items-center">
                                        <div className="col-lg-6">
                                            <div className="pricing-left">
                                                <img src="/assets/images/buy-100-instagram-followers.gif" alt="" />
                                            </div>
                                        </div>
                                        <div className="col-lg-6">
                                            <div className="pricing-right">
                                                <div className="pricing-offer">
                                                    ...
                                                    <div className="pricing-body">
                                                        <ul>
                                                            <li className="li-font"> <strong>High</strong> Quality</li>
                                                            <li className="li-font"> <strong>No Password</strong> Needed</li>
                                                            <li className="li-font"> Drop <strong>Protection</strong></li>
